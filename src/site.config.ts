...
export default {
  ...
  author: {
    ...
    bio: {
      ...
      ru: "Я просто обычный парень, который пытается найти или создать что-то крутое в интернете или в реальной жизни. Всегда в поиске чего-то прикольного."
    }
  },
  ...
  categories: {
    blog: {
      ...
      description: {
        ...
        ru: "Личные мысли, что посещают мою голову"
      }
    },
    technology: {
      enabled: false,
    ...
    projects: {
      ...
      icon: "🛠️",
      description: {
        en: "Just things I've made",
        ru: "Цифровой мусор, который я создал"
      }
    }
  },
